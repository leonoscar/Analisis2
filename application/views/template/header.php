...
<html>
  <head>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>/assets/js/jquery_blockUI.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>/assets/js/jqueryHelper.js"></script>

            ...
            <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="<?php echo base_url(); ?>Compras/Dasboardcompras">Compras Generales</a></li>
                    <li><a href="<?php echo base_url(); ?>Compras/Dasboardcompras/requisision">Requisisiones</a></li>
                    <li><a href="<?php echo base_url(); ?>Compras/Dasboardcompras/Cotizaciones">Cotizaciones</a></li>
                    <li><a href="<?php echo base_url(); ?>Compras/Dasboardcompras/OrdenCompras">Orden de Compra</a></li>
                    <li class="divider"></li>
                    <li><a href="<?php echo base_url(); ?>Compras/Dasboardcompras/Productos">Productos</a></li>
